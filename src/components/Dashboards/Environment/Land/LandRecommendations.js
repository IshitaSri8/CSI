...
const LandRecommendations = () => {
  const getRecommendationLand = () => {
    return (
      <>
        <ul>
         <li className="font-medium text-lg text p-0 m-0">
         ...
         <li className="font-medium text-lg text">
            <li className="text-lg text-primary1 font-semibold"> Smart Zoning Policies:</li>
         ...
         <li className="font-medium text-lg text">
            <li className="text-lg text-primary1 font-semibold">Urban Renewal Projects:</li>
